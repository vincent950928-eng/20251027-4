...
<html lang="en">
  <head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Noto+Sans+TC:wght@100..900&family=Rye&display=swap" rel="stylesheet">
  ...
  <body>
    ...
    <nav id="sideMenu" aria-label="側邊選單">
      <ul>
        ...
        <li class="submenu-parent">
          <a href="#" id="tkuLink">淡江大學</a>
          <ul class="submenu">
            <li><a href="#" id="tkuEtLink">教育科技學系</a></li>
          </ul>
        </li>
    ...
    <script>
      (function(){
        ...
        const urlTku = 'https://www.tku.edu.tw/';
        const urlTkuEt = 'https://www.et.tku.edu.tw/';
        ...
        const btnTku = document.getElementById('tkuLink');
        const btnTkuEt = document.getElementById('tkuEtLink');
        ...
        btnTku.addEventListener('click', function(e){ e.preventDefault(); openIframe(urlTku); });
        btnTkuEt.addEventListener('click', function(e){ e.preventDefault(); openIframe(urlTkuEt); });
